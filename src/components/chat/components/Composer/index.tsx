...
// import { IconButtonProps } from '@chatui/core';
import { Recorder, RecorderProps } from '@chatui/core/lib/components/Recorder';
import { Toolbar, ToolbarItemProps } from '@chatui/core/lib/components/Toolbar';
import { AccessoryWrap } from '@chatui/core/lib/components/Composer/AccessoryWrap';
import { Popover } from '@chatui/core/lib/components/Popover';
import { InputProps } from '@chatui/core/lib/components/Input';
import { ToolbarItem } from '@chatui/core/lib/components/Composer/ToolbarItem';
import { ComposerInput } from '@chatui/core/lib/components/Composer/ComposerInput';
// import { SendButton } from '@chatui/core/lib/components/Composer/SendButton';
...
export type ComposerProps = {
  ...
  renderSendButton?: () => React.ReactNode; // 新增定制发送按钮函数
  isX?: boolean;
};
...
export const Composer = React.forwardRef<ComposerHandle, ComposerProps>((props, ref) => {
  ...
  console.log('Composer props - rightAction ===> ', rightAction);
